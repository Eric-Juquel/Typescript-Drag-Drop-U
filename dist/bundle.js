...
define("components/project-input", ["require", "exports", "components/base-component", "util/validation", "decorators/autobind", "state/project-state"], function (require, exports, base_component_js_1, validation_js_1, autobind_js_1, project_state_js_1) {
    ...
    class ProjectInput extends base_component_js_1.Component {
        ...
        gatherUserInput() {
            ...
            if (!validation_js_1.validate(titleValidatable) ||
                ...
                !validation_js_1.validate(peaopleValidatable)) {
    ...
    ], ProjectInput.prototype, "submiHandler", null);
...
define("components/project-list", ["require", "exports", "models/project", "components/base-component", "decorators/autobind", "state/project-state", "components/project-item"], function (require, exports, project_1, base_component_js_3, autobind_js_3, project_state_js_2, project_item_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ProjectList extends base_component_js_3.Component {
        ...
        dropHandler(event) {
            ...
            project_state_js_2.projectState.moveProject(prjId, this.type === 'active' ? project_1.ProjectStatus.Active : project_1.ProjectStatus.Finished);
        }
        dragLeaveHandler(_) {
            const listEl = this.element.querySelector('ul');
